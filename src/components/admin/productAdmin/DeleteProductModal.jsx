    ...
    <div className="fixed inset-0 bg-[#0000009e] bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Xác nhận thay đổi trạng thái</h3>
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-4">
            Bạn có chắc chắn muốn {isActive ? "ẩn" : "hiển thị"} sản phẩm này?
          </p>
        ...
        <div className="flex justify-end space-x-3">
          ...
          >
            {isActive ? "Ẩn sản phẩm" : "Hiển thị sản phẩm"}
          </button>
        </div>
      </div>
    </div>
